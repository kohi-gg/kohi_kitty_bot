...
async function storeApiKey(discordUserId, apiKey, team_id, account_name) {
  try {
    await pool.query(
      'INSERT INTO user_api_keys (discord_user_id, api_key, team_id, account_name) VALUES ($1, $2, $3, $4) ON CONFLICT (discord_user_id) DO UPDATE SET api_key = EXCLUDED.api_key',
